...
jQuery( document ).ready( function($) {
  ...
  $( '#new-url' ).submit( function(e) {
    ...
    var raw_url = 'http://site.dev'; // if using a live site, should use HTTPS - since Codepen.io uses HTTPS

    // Check if the string entered in the form is a proper URL.
    try{
      $( '.error' ).remove();
