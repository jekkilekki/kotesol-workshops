 ...
 */
function workshop_show_if_front_page( $cmb ) {
 ...
 * @return bool                     True if metabox should show
 */
function workshop_hide_if_no_cats( $field ) {
 ...
 */
function workshop_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object.
 */
function workshop_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field object $field      Field object.
 */
function workshop_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'workshop_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function workshop_register_demo_metabox() {
	$prefix = 'workshop_demo_';
	...
	$cmb_demo = new_cmb2_box( array(
		...
		// 'show_on_cb' => 'workshop_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		...
		// 'classes_cb' => 'workshop_add_some_classes', // Add classes through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 'workshop_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'workshop_display_text_small_column', // Output the display of the column values through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type' => 'text',
		'render_row_cb' => 'workshop_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'workshop_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 'workshop_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function workshop_register_about_page_metabox() {
	$prefix = 'workshop_about_';
...
add_action( 'cmb2_admin_init', 'workshop_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function workshop_register_repeatable_group_field_metabox() {
	$prefix = 'workshop_group_';
...
add_action( 'cmb2_admin_init', 'workshop_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function workshop_register_user_profile_metabox() {
	$prefix = 'workshop_user_';
...
add_action( 'cmb2_admin_init', 'workshop_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function workshop_register_taxonomy_metabox() {
	$prefix = 'workshop_term_';
...
add_action( 'cmb2_admin_init', 'workshop_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function workshop_register_theme_options_metabox() {

	/**
	 * Registers options page menu item and form.
	 */
	$cmb_options = new_cmb2_box( array(
		'id'           => 'workshop_theme_options_page',
		...
		'option_key'      => 'workshop_theme_options', // The option key and admin menu page slug.
